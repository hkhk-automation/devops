...
| **Proxmox** | Win/Mac/Linux | 20 min | Keskmine | Tasuta | Õppimiseks |
| **Proxmox VM + Proxmox** | Win/Mac/Linux | 15 min | Keskmine | Tasuta | Reproducible |
...
### Proxmox Network (Täpsemad seaded)
...
# Proxmox (pärast bridged network setup):
...
```bash
# Start VM
multipass shell dev-lab  # või Proxmox/WSL2
